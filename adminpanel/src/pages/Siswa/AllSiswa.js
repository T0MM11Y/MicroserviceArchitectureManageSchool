...
function AllSiswa() {
  ...
  const fetchData = () => {
    ...
    fetch(`${URL_SISWA}api/siswa?_start=${offset}&_limit=${perPage}`)
                        ...
                        <div className="col-sm-12 col-md-6">
                          <div className="dt-buttons btn-group flex-wrap">
                            ...
                            >
                              ...
                              >
                                Add Siswa{" "}
                                <i className=" fas fa-user-plus align-middle ms-2"></i>
                              </Link>
                            </div>
                          </div>
                        </div>
                              ...
                              (
                                <tr key={siswa.ID}>
                                  ...
                                  <td>
                                    ...
                                    >
                                      <i className="far fa-edit align-middle "></i>
                                    </Link>
                                    <button
                                      className="btn btn-danger waves-effect waves-light"
                                      onClick={() => deleteSiswa(siswa.ID)}
                                    >
                                      <i className=" fas fa-trash-alt align-middle "></i>
                                    </button>{" "}
                                  </td>
                                </tr>
                              )
