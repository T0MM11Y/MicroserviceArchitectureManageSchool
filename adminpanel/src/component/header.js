...
const { BASE_URL, URL_LOGIN } = require("../configapi");
...
function Header() {
  ...
  const logoutOperation = async () => {
    try {
      const response = await fetch(`${URL_LOGIN}api/logoutAdmin`, {
        method: "POST",
      });
      if (response.ok) {
        ...
        Swal.fire("Failed", "Failed to logout", "error");
          ...
          <div className="navbar-brand-box">
            <a href="index.html" className="logo logo-dark">
              ...
              <span className="logo-lg">
                <img src="../images/real.png" alt="logo-dark" width="79%" />
                {/*real logo*/}
              </span>
            </a>
